...
namespace TextEditor.Controllers
{
    public class DocsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Content,UserId,IdentityUser")] Doc doc)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Content,UserId,IdentityUser")] Doc doc)
        {
            if (id != doc.Id)
            {
                return NotFound();
